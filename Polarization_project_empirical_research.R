...
setwd("C:/Users/Simon Bernhard/OneDrive - Universitaet Bern/Dokumente/Studium/Sozialwissenschaften/HS23 SOWI/Forschungspraktikum Training in Empirical Research/Paper/Data") # set working directory
